...
Minimal, Apache-2.0-licensed SSH 2.0 **server** for ESP-IDF (5.x and 6.x), written
...
shell. (A zero-initialized config just works: `listen_fd <= 0` makes littlessh
create the listening socket itself.)
